                ...
                <el-table :data="devices" style="width: 100%">
                        ...
                        <template slot-scope="props">
                            <el-form label-position="left" inline class="demo-table-expand">
                                ...
                                <el-form-item label="设备状态">
                                    <i :class=" props.row.status ? 'el-icon-ump-zaixian' : 'el-icon-ump-lixian1'" :style="props.row.status ? 'color: #2ea1f8' : 'color: #ff0000'"></i>
                    ...
                    <el-table-column label="设备状态" prop='status'>
                        <template slot-scope="scope">
                            <i :class=" scope.row.status ? 'el-icon-ump-zaixian' : 'el-icon-ump-lixian1'" :style="scope.row.status ? 'color: #2ea1f8' : 'color: #ff0000'"></i>
                    ...
                    <el-table-column label="设备标签" prop="tag">
                        <template slot-scope="scope">
