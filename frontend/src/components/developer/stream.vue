        ...
        <div class="box">
            ...
            <div class="box-table">
                <el-table :data="streams" style="width: 100%">
                    <el-table-column label="数据流名称" prop="name" align="center">
                    </el-table-column>
                    <el-table-column label="所属设备ID" prop="dev_id" align="center">
                    </el-table-column>
                    <el-table-column label="所属设备名" prop="dev_name" align="center">
                    </el-table-column>
                    <el-table-column label="单位名称" prop="unit" align="center">
                    </el-table-column>
                    <el-table-column label="单位符号" prop="unit_symbol" align="center">
                    </el-table-column>
                    <el-table-column label="阈值设置" align="center">
                        <el-table-column label="数值" prop="max" align="center">
                        </el-table-column>
                        <el-table-column label="判断类型" prop="trigger_type" align="center">
                    ...
                    <el-table-column label="是否开启触发器" prop="trigger" align="center">
                    </el-table-column>
                    <el-table-column label="QoS" prop="qos" align="center">
                    </el-table-column>
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            ...
                            <el-tooltip content="删除" placement="top">
                                <i class="el-icon-ump-shanchu" @click="delStream(scope.row.dev_id,scope.row.name)" style="padding-left:5px;"></i>
                            </el-tooltip>
                        </template>
                    </el-table-column>
                </el-table>
                ...
                <el-form v-model="streams_info">
                    ...
                    <el-form-item label="判断类型:" label-width="100px">
                        <el-select v-model="streams_info.min">
                            <el-option v-for="item in trigger_type" :key="item.value" :label="item.label" :value="item.value">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-form v-model="new_streams_info">
                    ...
                    <el-form-item label="选择设备" label-width="100px">
                        <el-select v-model="new_streams_info.dev_id" placeholder="请选择">
                            <el-option v-for="item in dev_info" :key="item.id" :label="item.name" :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="判断类型" label-width="100px">
