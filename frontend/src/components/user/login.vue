                    ...
                    <div class="part">
                        <el-form :model="loginForm" ref="loginForm" status-icon :rules="rules">
                            <el-form-item prop="username" :error="errorMsg1">
                                <el-input type="text" prefix-icon="el-icon-d-arrow-right" placeholder="请输入用户名或者ID" v-model="loginForm.username"></el-input>
                            </el-form-item>
                            <el-form-item prop="password" :error="errorMsg2">
                                <el-input type="password" prefix-icon="el-icon-d-arrow-right" placeholder="请输入密码" v-model="loginForm.password"></el-input>
                            </el-form-item>
                            <el-form-item prop="verifycode">
                                <el-input type="text" style="float: left;width: 340px" prefix-icon="el-icon-d-arrow-right" placeholder="请输入验证码" v-model="loginForm.verifycode"></el-input>
